...
DamagedItem.objects.create(damaged_entry=de1, apparatus_name='Beaker 250ml (Borosil)', quantity_ml=3, caused_by='Thermal stress')
...
DamagedItem.objects.create(damaged_entry=de2, apparatus_name='Test Tube (15x150mm)', quantity_ml=10, caused_by='Mishandling with tongs')
...
DamagedItem.objects.create(damaged_entry=de3, apparatus_name='Thermometer (-10 to 110C)', quantity_ml=2, caused_by='Dropped during setup')
...
DamagedItem.objects.create(damaged_entry=de5, apparatus_name='Burette 50ml (with stopcock)', quantity_ml=1, caused_by='Mishandling of stopcock')
